...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { english: @mark.english, history: @mark.history, math: @mark.math, science: @mark.science } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { english: @mark.english, history: @mark.history, math: @mark.math, science: @mark.science } }
